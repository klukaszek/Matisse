"""JAX/Equinox implementation of NeuralScope internal percept module."""
import jax
...
class NS_internal_percept(eqx.Module):
    ...
    def __init__(self, latent_dim: int = 8, output_dim: int = 3, *, key: jax.random.PRNGKey):
        """Initialize the neural scope internal percept module.
